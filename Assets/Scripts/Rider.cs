...
public class Rider : Tower
{
    ...
    void Start()
    {
		...
		CircleDrawer.radius = 4f;
		display = Instantiate (rangeIndicator, this.transform);
    }

	/// <summary>
	/// When the mouse hover the Rider, this method
	...
	/// is on top of the Rider. On left click, call ShowUpgrade 
	/// to display the upgrade panel
	/// </summary>
	public void OnMouseOver ()
	{
		if (Input.GetMouseButtonUp (0)) {
			Debug.Log ("Rider clicked");
			AudioManager.Instance.PlayRiderClick ();
	...
	/// not over the Rider anymore and the range display
	/// will be removed.
	/// </summary>
